...
if __name__ == '__main__':
    ...
    estimators = [('imputer', SimpleImputer()), ('scaler', StandardScaler()), ('clf', GradientBoostingClassifier(subsample=0.5, min_weight_fraction_leaf=0.003, random_state=0))] #
    pipe = Pipeline(estimators)                     

    param_grid = {"clf__n_estimators": [250,300,350,400,450,500,550,600,650,700,750], "clf__learning_rate": [0.08,0.09,0.1,0.11,0.12,0.14], "clf__max_depth": [3,4,5,6,7,8]}
