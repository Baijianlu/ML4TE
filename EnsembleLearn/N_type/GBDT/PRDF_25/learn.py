...
if __name__ == '__main__':
    ...
    estimators = [('scaler', StandardScaler()), ('clf', GradientBoostingClassifier(min_weight_fraction_leaf=0.003, random_state=0))] #
    pipe = Pipeline(estimators)                     

    param_grid = {"clf__n_estimators": [100,200,300,400,500,600], "clf__learning_rate": [0.04,0.06,0.08,0.1,0.12,0.14], "clf__max_depth": [3,4,5,6,7], "clf__subsample": [0.5,0.6,0.7,0.8,0.9]}
