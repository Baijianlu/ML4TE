...
if __name__ == '__main__':
    ...
    df1 = pd.read_excel("X_train_n_withM3GNet.xlsx", sheet_name='Sheet1',index_col=0)
    df2 = pd.read_excel("X_test_n_withM3GNet.xlsx", sheet_name='Sheet1',index_col=0)
    ...
    excludes = ['name','structure_opt','n_con','n_PF','structure','compound possible']
