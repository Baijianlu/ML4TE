...
if __name__ == '__main__':
    ...
    param_grid = {"clf__subsample": [0.5,0.6,0.7,0.8,0.9], "clf__colsample_bynode":[0.6,0.7,0.8,0.9,1.0], "clf__n_estimators": [100,150,200,250,300], "clf__learning_rate": [0.25,0.27,0.29,0.3,0.32,0.34,0.35], "clf__max_depth": [2,3,4,5]}
