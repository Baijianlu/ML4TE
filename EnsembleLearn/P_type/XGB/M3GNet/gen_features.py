...
if __name__ == '__main__':
    ...
    df1 = pd.read_excel("X_train_p_withM3GNet.xlsx", sheet_name='Sheet1',index_col=0)
    df2 = pd.read_excel("X_test_p_withM3GNet.xlsx", sheet_name='Sheet1',index_col=0)
    ...
    excludes = ['name','structure_opt','p_con','p_PF','structure','compound possible']
