...
if __name__ == '__main__':
    ...
    param_grid = {"clf__subsample": [0.5,0.6,0.7,0.8,0.9], "clf__colsample_bynode":[0.6,0.7,0.8,0.9,1.0], "clf__n_estimators": [100,200,250,300,350,400,500,600], "clf__learning_rate": [0.02,0.04,0.06,0.07,0.08,0.09], "clf__max_depth": [2,3,4,5,6,7]}
