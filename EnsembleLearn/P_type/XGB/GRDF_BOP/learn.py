...
if __name__ == '__main__':
    ...
    estimators = [('imputer', SimpleImputer()), ('scaler', StandardScaler()), ('clf', XGBClassifier(tree_method='exact',importance_type='gain',scale_pos_weight=2.0954545,n_jobs=4,random_state=0))] #
    pipe = Pipeline(estimators)                     

    param_grid = {"clf__subsample": [0.5,0.6,0.7,0.8,0.9], "clf__colsample_bynode":[0.6,0.7,0.8,0.9,1.0], "clf__n_estimators": [200,300,400,450,500,550,600,700], "clf__learning_rate": [0.02,0.04,0.06,0.07,0.08,0.09,0.1], "clf__max_depth": [2,3,4,5,6]}
