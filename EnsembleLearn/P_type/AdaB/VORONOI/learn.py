...
if __name__ == '__main__':
    ...
    dt_stump = DecisionTreeClassifier(min_weight_fraction_leaf=0.0022,class_weight='balanced')
    estimators = [('imputer', SimpleImputer()), ('scaler', StandardScaler()), ('clf', AdaBoostClassifier(base_estimator=dt_stump, random_state=0))] #
    pipe = Pipeline(estimators)                     

    param_grid = {"clf__n_estimators": [100,150,200,250,300,350,400,500], "clf__learning_rate": [0.02,0.04,0.05,0.06,0.08,0.09,0.1,0.11], "clf__base_estimator__max_depth": [1,2,3]}
