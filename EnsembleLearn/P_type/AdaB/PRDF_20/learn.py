...
if __name__ == '__main__':
    ...
    param_grid = {"clf__n_estimators": [100,200,300,400,450,500,550,600,700,800], "clf__learning_rate": [0.02,0.04,0.06,0.07,0.08,0.09,0.1], "clf__base_estimator__max_depth": [1,2,3]}
