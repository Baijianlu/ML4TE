...
#        return torch.optim.SGD(self.parameters(), self.lr, weight_decay=0.0045)
        params_wonode = [param for name, param in self.net.named_parameters() if re.match('embedding.layer_node_embedding', name) is None]
        return torch.optim.Adam(params_wonode, lr=self.lr, eps=1e-8, weight_decay=0.0026)
...
if __name__ == '__main__':
    ...
    trainer.fit(model, data, dims, filepath='/home/taofan/work/MachineLearn/pytorch/M3GNet/N_type_unit32/WD01', dropout=0.0)
